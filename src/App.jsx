...
export default function CapitalGainsTaxLanding() {
  ...
  /** CTA BUTTON – now anchors to form */
        ...
        <div className="w-full max-w-[1400px]">
          ...
          <section className="relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-14 pb-16 md:pt-20 md:pb-20 grid md:grid-cols-2 gap-10">
              ...
              {/* FORM */}
              <div id="book" className="bg-white rounded-2xl shadow-xl border border-[#A9CFE0] p-6 transition-all">
          ...
          {/* FAQ (py-16 removed) */}
          <section id="faq" className="bg-[#F3F3E3] py-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-8 grid md:grid-cols-2 gap-6">
                {[
                  ...
                  { q: "Do you provide tax advice?", a: "We guide strategy, but recommend licensed professionals." },
